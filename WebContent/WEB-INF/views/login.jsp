	...
	<div class="container w3layouts agileits">
		...
		<div class="login w3layouts agileits">
			<h2>登 录</h2>
				...
				<input type="button" value="登 录" class="layui-btn layui-btn-primary layui-btn-normal" id="login">
			<div class="clear"></div>
		</div>
		<div class="register w3layouts agileits">
			<h2>注 册</h2>
				...
				<input type="button" value="免费注册" class="layui-btn layui-btn-primary layui-btn-normal" id="register">
			<div class="clear"></div>
		</div>
